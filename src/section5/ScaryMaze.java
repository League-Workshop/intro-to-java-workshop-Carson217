...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("Workshop thingy.jpg"));
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("Disney Intro (MLG Air Horn Remix).wav"));
		...
		showScaryImage("maxresdefault.jpg");
	}
